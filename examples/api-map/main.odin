...
map_build :: proc(builder: ^fit.Builder, user_data: rawptr) {
	_ = user_data
...
map_measure :: proc(constraints: fit.Constraints, user_data: rawptr) -> fit.Size {
	_ = user_data
...
map_render :: proc(surface: ^fit.Surface, rect: fit.Rect, user_data: rawptr) -> bool {
	_ = user_data
