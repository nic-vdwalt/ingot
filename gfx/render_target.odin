...
// load_render_texture_ex creates a render target with an explicit colour format
...
// rl_load_color_texture creates a render-target colour texture of `pf` and returns
