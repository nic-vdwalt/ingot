...
[![The Ingot API relationships gallery](docs/media/gallery-api-relationships-dark.png)](https://openalloy.ai/demos/ingot-gallery/)
...
this generated preview links to the live gallery.
...
rather than decoration. The same build is published as the live gallery linked
above.
