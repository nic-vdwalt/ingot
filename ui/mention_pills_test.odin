...
workspace_path_registry :: proc(t: ^testing.T) {
	...
	testing.expect(t, workspace_has_path_with(files, "src/main.odin:42-84"))
	...
	testing.expect(t, !workspace_has_path_with(files, "src/main.odin:84-42"))
	testing.expect(t, !workspace_has_path_with(files, "src/main.odin:42-0"))
