...
interact_frame_codec_preserves_actions_and_boundaries :: proc(t: ^testing.T) {
	frame := Frame_Op{count = 2, control = {hide_slider = 3, open_modal = true, open_menu = true, menu_x = 71, menu_y = 92}}
	frame.actions[0] = {kind = .Mouse, a = -4, b = 601}
	frame.actions[1] = {kind = .Key, a = i32(rl.KeyboardKey.TAB), b = 1}
...
interact_tape_rejects_unknown_and_malformed_frames :: proc(t: ^testing.T) {
	tape := fuzzx.Tape{version = fuzzx.TAPE_VERSION, target = "interact"}
